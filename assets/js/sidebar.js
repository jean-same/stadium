...
class Sidebar {
  constructor(sidebarElement, options = {}) {
    this.sidebarEL = sidebarElement instanceof HTMLElement ? sidebarElement : document.querySelector(sidebarElement)
  ...
  init() {
    ...
    document.querySelectorAll('.burger-btn').forEach(sidebarElement => sidebarElement.addEventListener('click', this.toggle.bind(this)))
    document.querySelectorAll('.sidebar-hide').forEach(sidebarElement => sidebarElement.addEventListener('click', this.toggle.bind(this)))
